    ...
    <div class="row">
        ...
        <div class=" col-md-12">
            <div class="card card-success">
                ...
                <div class="card-body">
                    <table id="master_roale" class="table table-bordered table-hover" style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nama</th>
                        ...
                        <tbody>
                            @foreach ($vjenis as $d)
                                <tr>
                                    ...
                                    <td>{{ $d->role_status }}</td>
                                    <td>
                                        <a href="{{ route('getDataRole',['id'=>$d->role_id]) }}" class="btn btn-primary">
                                            Edit
                                        </a>
                                        @if ($d->role_status == 'aktif')
                                            <a href="{{ route('role_masterdel', ['id'=>$d->role_id]) }}" class="btn btn-danger">
                                                Hapus
                                            </a>
                                        @else
                                        <a href="{{ route('role_masterdel', ['id'=>$d->role_id]) }}" class="btn btn-danger">
